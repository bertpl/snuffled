...
@pytest.mark.parametrize(
    ...
    [
        (f_score_linear, [-1.0, -0.2, 0.2, 1.0], 1e-9, 0.0, 1e-6),
        (f_score_linear, [-1.0, -1e-9, 0.0, 1e-9, 1.0], 1e-9, 0.0, 1e-6),
        (f_score_sign, [-1.0, -0.2, 0.2, 1.0], 1e-9, 0.0, 1e-6),
        (f_score_sign, [-1.0, -1e-9, 0.0, 1e-9, 1.0], 1e-9, 0.999, 1.0),
    ],
)
