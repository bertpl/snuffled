...
def fit_curve(
    ...
    """Tailored approach to find approximately optimal initial parameters within provided b and c bounds.

    Optimality is measured according to the 'fitting_cost' method.
