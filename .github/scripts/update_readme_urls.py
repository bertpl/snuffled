...
def render_template(python_versions: list[str], package_version: str) -> list[str]:
    ...
    return [
        ...
        for line in textwrap.dedent(
            f"""![shields.io-python-versions](https://img.shields.io/badge/python-{url_python_versions}-blue)
                ![genbadge-test-count](https://bertpl.github.io/snuffled/version_artifacts/v{package_version}/badge-tests.svg)
